...
$GLOBALS['TL_DCA']['tl_issue_service'] = [
	...
	'palettes' => [
		'default' => '{title_legend},title,alias,description;
					  {defaults_legend},default_priority,default_assignee_id,notification_recipients;
	...
	'fields' => [
		...
		'description' => [
			'inputType' => 'textarea', 'sql' => 'longtext NULL'
		],
		'default_priority' => [
			'inputType' => 'select', 
			'options' => ['low', 'normal', 'high', 'critical'], 
			'reference' => &$GLOBALS['TL_LANG']['tl_issue_service']['default_priority_options'], 
