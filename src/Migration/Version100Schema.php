...
final class Version100Schema extends AbstractMigration 
{
    ...
    {
        return [
        "CREATE TABLE tl_issue_service (id INT UNSIGNED AUTO_INCREMENT NOT NULL,tstamp INT UNSIGNED DEFAULT 0 NOT NULL,title VARCHAR(160) DEFAULT '' NOT NULL,alias VARCHAR(160) DEFAULT '' NOT NULL,description LONGTEXT DEFAULT NULL,default_priority VARCHAR(16) DEFAULT 'normal' NOT NULL,default_assignee_id INT UNSIGNED DEFAULT NULL,notification_recipients LONGTEXT DEFAULT NULL,published TINYINT(1) DEFAULT 1 NOT NULL,UNIQUE INDEX uq_service_alias (alias),PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE=InnoDB",
        "CREATE TABLE tl_issue_category (id INT UNSIGNED AUTO_INCREMENT NOT NULL,tstamp INT UNSIGNED DEFAULT 0 NOT NULL,service_id INT UNSIGNED DEFAULT 0 NOT NULL,title VARCHAR(160) DEFAULT '' NOT NULL,alias VARCHAR(160) DEFAULT '' NOT NULL,published TINYINT(1) DEFAULT 1 NOT NULL,UNIQUE INDEX uq_category_service_alias (service_id,alias),INDEX idx_category_service (service_id),PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE=InnoDB",
        "CREATE TABLE tl_issue_status (id INT UNSIGNED AUTO_INCREMENT NOT NULL,tstamp INT UNSIGNED DEFAULT 0 NOT NULL,status_key VARCHAR(32) NOT NULL,title VARCHAR(100) NOT NULL,sort_order SMALLINT UNSIGNED DEFAULT 0 NOT NULL,is_initial TINYINT(1) DEFAULT 0 NOT NULL,is_resolved TINYINT(1) DEFAULT 0 NOT NULL,is_closed TINYINT(1) DEFAULT 0 NOT NULL,color VARCHAR(6) DEFAULT NULL,published TINYINT(1) DEFAULT 1 NOT NULL,UNIQUE INDEX uq_status_key (status_key),PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE=InnoDB",
        ...
        "CREATE TABLE tl_issue (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL,tstamp INT UNSIGNED DEFAULT 0 NOT NULL,uuid BINARY(16) DEFAULT NULL,ticket_number VARCHAR(64) DEFAULT NULL,member_id INT UNSIGNED DEFAULT NULL,guest_access_hash CHAR(64) DEFAULT NULL,service_id INT UNSIGNED NOT NULL,category_id INT UNSIGNED DEFAULT NULL,status_id INT UNSIGNED NOT NULL,issue_type VARCHAR(32) NOT NULL,title VARCHAR(255) NOT NULL,description MEDIUMTEXT DEFAULT NULL,priority VARCHAR(16) DEFAULT 'normal' NOT NULL,assigned_user_id INT UNSIGNED DEFAULT NULL,resolution MEDIUMTEXT DEFAULT NULL,created_at DATETIME DEFAULT NULL,updated_at DATETIME DEFAULT NULL,last_public_activity_at DATETIME DEFAULT NULL,resolved_at DATETIME DEFAULT NULL,closed_at DATETIME DEFAULT NULL,deleted_at DATETIME DEFAULT NULL,version INT UNSIGNED DEFAULT 1 NOT NULL,UNIQUE INDEX uq_issue_uuid (uuid),UNIQUE INDEX uq_ticket (ticket_number),INDEX idx_member_activity (member_id,last_public_activity_at),INDEX idx_service_status (service_id,status_id),INDEX idx_assignee_status (assigned_user_id,status_id),PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE=InnoDB",
        ...
        "CREATE TABLE tl_issue_settings (id INT UNSIGNED AUTO_INCREMENT NOT NULL,tstamp INT UNSIGNED DEFAULT 0 NOT NULL,setting_key VARCHAR(100) DEFAULT '' NOT NULL,value_type VARCHAR(20) DEFAULT 'string' NOT NULL,setting_value LONGTEXT DEFAULT NULL,updated_by INT UNSIGNED DEFAULT NULL,updated_at DATETIME DEFAULT NULL,version INT UNSIGNED DEFAULT 1 NOT NULL,UNIQUE INDEX uq_setting_key (setting_key),PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE=InnoDB",
