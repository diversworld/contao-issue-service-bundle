...
$GLOBALS['TL_DCA']['tl_issue_status'] = [
	...
	'palettes' => [
		'default' => '{title_legend},status_key,title,sort_order,color;
					  {state_legend},is_initial,is_resolved,is_closed;
	...
	'fields' => [
		...
		'title' => [
			'inputType' => 'text', 
			'eval' => ['mandatory' => true, 'maxlength' => 100], 'search' => true, 
		...
		'color' => [
			'inputType' => 'text', 
			'eval' => ['maxlength' => 6, 'colorpicker' => true, 'isHexColor' => true, 'decodeEntities' => true, 'tl_class' => 'w25 wizard'], 
			'sql' => 'varchar(6) NULL'
		],
		'published' => [
			'inputType' => 'checkbox', 
