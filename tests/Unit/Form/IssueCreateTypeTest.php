...
final class IssueCreateTypeTest extends TestCase
{
    public function testCategoryAndPriorityChoicesAreValidated(): void
    {
        ...
        $db->method('fetchOne')->willReturnCallback(static fn (string $sql, array $params): int|false => $params['c'] === 3 && $params['s'] === 1 ? 1 : false);
        ...
        $factory = Forms::createFormFactoryBuilder()
            ...
            ->addType(new IssueCreateType(new ServiceRepository($db)))
            ->getFormFactory();
