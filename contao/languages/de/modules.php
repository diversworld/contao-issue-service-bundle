...
$GLOBALS['TL_LANG']['MOD']['issue_service_issues']=['Tickets', 'Tickets, Kommentare und Anhänge verwalten.'];
$GLOBALS['TL_LANG']['MOD']['issue_service_services']=['Services', 'Services und Kategorien verwalten.'];
$GLOBALS['TL_LANG']['MOD']['issue_service_categories']=['Kategorien', 'Ticket-Kategorien verwalten.'];
$GLOBALS['TL_LANG']['MOD']['issue_service_workflow']=['Workflow', 'Status und Übergänge verwalten.'];
$GLOBALS['TL_LANG']['MOD']['issue_service_settings']=['Konfigurationsprofile', 'Vollständige Konfigurationen für Aufgaben oder Mandanten verwalten.'];
