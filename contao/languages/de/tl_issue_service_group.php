...
$GLOBALS['TL_LANG']['tl_issue_service_group']['show'] = ['Servicegruppen-Details', 'Details der Servicegruppe anzeigen.'];

$GLOBALS['TL_LANG']['tl_issue_service_group']['service_id'] = ['Service', 'Zugeordneter Service.'];
