...
[Beispiel-SQL](../examples/workflow.sql) legt 23 aktive Regeln für die vorhandenen Standardstatus an. Bereits vorhandene Regeln bleiben unverändert. Jede angegebene Rolle erhält einen eigenen Datensatz.
