...
$GLOBALS['TL_DCA']['tl_issue_comment'] = [
    ...
    'label' => ['fields' => ['created_at', 'author_type', 'body'], 'format' => '%s [%s] %s'], 
    'operations' => [
        'edit',
        'children',
        'copy',
    ...
    'fields' => [
        ...
        'visibility' => ['inputType' => 'select', 'options' => ['public', 'internal'], 'reference' => &$GLOBALS['TL_LANG']['tl_issue_comment']['visibility_options'], 'sql' => "varchar(16) NOT NULL default 'public'"],
        'author_type' => ['inputType' => 'select', 'options' => ['member', 'guest', 'user', 'system'], 'reference' => &$GLOBALS['TL_LANG']['tl_issue_comment']['author_type_options'], 'sql' => "varchar(16) NOT NULL default 'system'"],
