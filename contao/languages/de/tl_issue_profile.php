...
$GLOBALS['TL_LANG']['tl_issue_profile']['reopen_roles'] = ['Rollen zum Wiederöffnen', 'Bisheriger Rollenparameter; Statuswechsel werden weiterhin über die Workflow-Regeln gesteuert.'];
$GLOBALS['TL_LANG']['tl_issue_profile']['service_scoped_permissions'] = ['Servicebezogene Berechtigungen', 'Bisheriger Parameter; ein Profil allein trennt keine Mandantenzugriffe.'];
